        ...
        <div class="row gx-lg-5 align-items-center mb-5">
            <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
                <h1 class="my-5 display-5 fw-bold ls-tight" style="color: hsl(218, 81%, 95%)">
                    ...
                    <span style="color: hsl(218, 81%, 75%)">for your Learning</span>
                </h1>
            ...
            <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
                ...
                <div class="card bg-glass">
                    <div class="card-body px-4 py-5 px-md-5">
                        <h1 class="card-title text-center mb-3 fw-dark fs-1">SIGN UP</h1>
                        <form action="/createsubmit" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-outline mb-4">
                                    <input type="text" name="name" id="floatingName" placeholder="Name"
                                        class="form-control" />
                            ...
                            <div class="form-outline mb-4">
                                <input type="password" name="re-password" id="floatingRePassword"
                                    placeholder="Re-Enter Password" class="form-control" />
                                <label class="form-label" for="form3Example5">Re-Enter Password</label>
                            </div>
                            ...
                            <div class="form-check d-flex justify-content-center mb-4">
                                <input class="form-check-input me-2" type="checkbox" value="" id="form2Example33"
                                    un-checked />
                                <label class="form-check-label" for="form2Example33">I agree to the <a href="#">Terms
                                        and Conditions</a>
                                </label>
                            </div>
